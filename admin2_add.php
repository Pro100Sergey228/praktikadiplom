        ...
        <div id="info_text2">
            ...
            <?php
                ...
                $link = mysqli_connect($host, $user, $password, $database)
                    ...
                    if (isset($_POST['title'], $_POST['date_time'], $_POST['time'],  $_POST['cabinet'])) {
                        require 'connection.php';
                        $link = mysqli_connect($host, $user, $password, $database)
                            or die("Ошибка " . mysqli_error($link));
                
                                    $resultt = mysqli_query($link, "SELECT * FROM schedule ");
                        ...
                        if (!empty($_POST['title']) && !empty($_POST['date_time']) && !empty($_POST['time'])  && !empty($_POST['cabinet'])) {
                                ...
                                $query = "INSERT INTO schedule VALUES($rows,'$title','$date_time','$time','$cabinet')";
